          ...
          <form onSubmit={handleRegistration} className="max-w-5xl mx-auto pt-10 px-10 lg:px-0 text-white">
            ...
            <div className="flex justify-center">
              <button
                disabled={loading}
                type="submit"
                className={`mt-5 w-40 py-2 uppercase text-base font-bold text-gray-300 tracking-wide rounded-md hover:text-white hover:opacity-80 duration-200 ${loading ? "bg-gray-500 hover:bg-gray-500":"bg-skyText-700"}`}
              >
